...
public final class KeyboardTests {
    ...
    @Test public void newlineBecomesSpace(){
        assertEquals("a b c",KeyCodec.normalize("a\nb\r\nc"));
    }

    @Test(expected=IllegalArgumentException.class)
    public void unicodeRejected(){
        KeyCodec.normalize("🙂");
    }

    @Test public void releaseIsEightZeroBytes(){
        assertArrayEquals(new byte[8],KeyCodec.release());
    }
    ...
    @Test public void editPlanAppend(){
        EditPlan p=new EditPlan("Hel","Hello");
